        ...
        <div id="main-content" class="main-content">
            <div id="primary" class="content-area">
                <div id="content" class="site-content" role="main">
                    ...
                    <div class="row mt-4">
                        <div class="col-md-12 shop-cart-table">
                        ...
                        <div class="col-12 cart-total pt-1-9 pt-lg-2-3">
                            <div class="row">
                                ...
                                @if($cart['subTotal'] !=0)
                                <div class="col-lg-6 offset-lg-1 col-md-7 offset-md-0 text-right ">
                                ...
                                <div class="col-md-12 text-right">
                                    <a class="btn btn-dark float-end" href="{{route('checkout')}}"><span>Proceed to Checkout</span></a>
                                </div>
                                @endif
                            </div>
                        </div>
